...
class Tropa_Gato_amigo2 (Nivel:Int = 1) : Tropa(
    nombre = "Tropa_Gato_amigo2",
    nivel = Nivel,
    ...
    aereo = false,
    estado_de_vida = true,
    rutaviva = R.drawable.gato_amigo,
    ...
    fun uiiaiuiiiai(enemigos: ArrayList<Tropa?>, posicion: Int,Waos: Boolean) {
        var xd = Random.nextInt(100)
        if(xd < this.precision){
            //sigue realizando tu atque
        }else{
    ...
    override fun clonar(): Tropa {
        val copia = Tropa_Gato_amigo2(this.nivel)
