...
//no sirve cuando se usa entornos o eventos,ya q no emula eso,solo ataques de daño.
  //Los ataques emulados no toman en consideracion la probabilidad de critico y muchas probabilidades
